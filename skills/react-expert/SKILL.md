...
name: react-expert
description: >
  React 18+/19 컴포넌트 구현. TRIGGER when the user writes .jsx/.tsx components or custom hooks, debugs
  rendering, migrates class components, works with Server Components, Suspense, or useActionState,
  or tunes React performance.
license: MIT
metadata:
