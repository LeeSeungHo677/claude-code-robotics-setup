...
description: >
  클라우드 아키텍처 설계와 마이그레이션. TRIGGER when the user designs on AWS/Azure/GCP, plans a migration or
  landing zone, optimizes cloud cost, designs disaster recovery, or applies the Well-Architected
  Framework.
license: MIT
metadata:
