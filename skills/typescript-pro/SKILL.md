...
name: typescript-pro
description: >
  고급 TypeScript 타입 시스템. TRIGGER when the user writes generics, conditional or mapped types,
  discriminated unions, type guards, branded types, sets up a monorepo, or wires tRPC for
