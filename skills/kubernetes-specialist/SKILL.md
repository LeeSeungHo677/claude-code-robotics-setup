...
description: >
  Kubernetes 워크로드 배포·운영. TRIGGER when the user writes deployment manifests or Helm charts,
  configures RBAC, NetworkPolicies, service accounts, storage, or GitOps, debugs pod crashes, or
  right-sizes resource limits across clusters.
license: MIT
metadata:
