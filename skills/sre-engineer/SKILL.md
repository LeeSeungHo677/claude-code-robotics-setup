...
name: sre-engineer
description: >
  SRE — SLO·에러 예산·장애 대응. TRIGGER when the user defines SLIs/SLOs, sets error budget policy,
  designs incident response or postmortem process, plans capacity, runs chaos engineering, or
  reduces toil.
license: MIT
metadata:
