...
description: >
  로봇 소프트웨어 모듈 설계 원칙. TRIGGER when the user structures a robot codebase, designs interfaces for
  hardware, applies SOLID or clean architecture to robots, plans error handling and configuration
  management, separates perception-planning-control concerns, or reviews and refactors robotics
  code.
---
