...
description: >
  로봇 시스템 보안 강화. TRIGGER when the user configures SROS2 or DDS encryption and access control,
  generates a keystore or certificates, segments a robot fleet network, hardens an onboard
  computer, manages robot secrets, isolates a safety controller, or works toward IEC 62443 for
  robotics.
---
