...
description: >
  로봇 소프트웨어 아키텍처 패턴. TRIGGER when the user chooses between behavior trees and state machines,
  designs perception-planning-control pipelines, adds watchdogs/heartbeats/graceful degradation,
  builds a hardware abstraction layer, designs safety architecture, or plans sim-to-real and
