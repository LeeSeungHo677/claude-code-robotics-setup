...
description: >
  ROS 2 개발 전반의 API 레퍼런스이자 코드 템플릿. TRIGGER when the user writes or reviews rclcpp/rclpy nodes,
  colcon/ament packages, launch files, QoS·DDS·Zenoh, executors and callback groups,
  URDF/xacro·tf2, ros2_control, Nav2/MoveIt 2, rosbag2, micro-ROS, SROS2, or E-stop and safety
  chains. DO NOT TRIGGER for general C++/Python unrelated to ROS 2.
---
