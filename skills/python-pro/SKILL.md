...
name: python-pro
description: >
  Python 3.11+ 타입 안전·비동기 코드. TRIGGER when the user writes type-annotated Python, configures mypy
  strict, uses async/await, dataclasses, or dependency injection, sets up pytest fixtures and
  mocking, or runs black/ruff.
license: MIT
metadata:
