...
description: >
  Terraform 기반 IaC. TRIGGER when the user writes reusable modules, manages state (backend
  migration, import, conflict resolution), configures providers, runs multi-environment workflows,
  or tests infrastructure on AWS/Azure/GCP.
license: MIT
metadata:
