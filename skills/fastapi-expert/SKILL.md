...
name: fastapi-expert
description: >
  FastAPI·Pydantic V2 기반 비동기 Python API. TRIGGER when the user builds REST endpoints, Pydantic
  models, JWT auth flows, async SQLAlchemy, WebSocket endpoints, or OpenAPI docs with FastAPI.
license: MIT
metadata:
