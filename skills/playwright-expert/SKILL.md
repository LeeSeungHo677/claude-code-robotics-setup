...
description: >
  Playwright E2E 테스트. TRIGGER when the user writes browser tests, builds page objects and
  fixtures, mocks APIs in tests, adds CI integration, does visual regression, or debugs flaky
  browser tests.
license: MIT
metadata:
