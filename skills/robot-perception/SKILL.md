...
description: >
  로봇 인지 센서 처리 — 카메라·LiDAR·깊이·IMU. TRIGGER when the user works with OpenCV/Open3D/PCL,
  RealSense/ZED/OAK-D, point cloud filtering or ICP, stereo/RGBD depth, AprilTag/ArUco, camera
  intrinsics and undistortion, multi-camera rigs and frame synchronization, or perception latency
  budgets. 캘리브레이션 절차는 robot-calibration 스킬.
---
