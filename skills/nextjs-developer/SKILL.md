...
description: >
  Next.js 14+ App Router 앱 구현. TRIGGER when the user works with server components, server actions,
  route handlers, middleware, streaming SSR, generateMetadata, or loading/error boundaries, or
  deploys to Vercel. DO NOT TRIGGER for plain React without Next.js.
license: MIT
metadata:
