...
description: >
  분산 시스템·마이크로서비스 설계. TRIGGER when the user decomposes a monolith into bounded contexts, defines
  service boundaries, applies DDD, saga, event sourcing, or CQRS, or plans a service mesh and
  distributed tracing.
license: MIT
metadata:
